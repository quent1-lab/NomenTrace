// Onglet « Listes de valeurs » des paramètres : vocabulaire propre au projet suivi.
...
function rendre() {
  ...
  conteneur.replaceChildren(
    el(
      "p",
      { class: "texte-doux" },
      "Ces listes portent le vocabulaire du projet suivi. Renommer une valeur ne change que son libellé affiché : " +
...
export async function afficherListes(cible) {
  conteneur = cible;
  await chargerListes();
  rendre();
}
